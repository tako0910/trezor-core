...
class TestAddress(unittest.TestCase):
    ...
    def test_paths_bch(self):
        ...
        correct_derivation_paths = [
            ...
            ([45 | HARDENED, 145 | HARDENED, 0 | HARDENED, 0, 0], InputScriptType.SPENDMULTISIG),
            ([45 | HARDENED, 145 | HARDENED, 5 | HARDENED, 0, 0], InputScriptType.SPENDMULTISIG),
            ([45 | HARDENED, 145 | HARDENED, 5 | HARDENED, 0, 10], InputScriptType.SPENDMULTISIG),
        ]
    ...
    def test_paths_public_key(self):
        ...
        correct_derivation_paths = [
            ...
            ([44 | HARDENED, 0 | HARDENED, 0 | HARDENED], InputScriptType.SPENDADDRESS),
            ([44 | HARDENED, 0 | HARDENED, 0 | HARDENED, 1, 0], InputScriptType.SPENDADDRESS),
            ([49 | HARDENED, 0 | HARDENED, 0 | HARDENED, 0, 0], InputScriptType.SPENDP2SHWITNESS),
            ([49 | HARDENED, 0 | HARDENED, 0 | HARDENED, 1, 0], InputScriptType.SPENDP2SHWITNESS),
        ...
        coin = coins.by_shortcut('BTC')
        for path, input_type in correct_derivation_paths:
            self.assertTrue(validate_path_for_bitcoin_public_key(path, coin, input_type))

        for path, input_type in incorrect_derivation_paths:
            self.assertFalse(validate_path_for_bitcoin_public_key(path, coin, input_type))
